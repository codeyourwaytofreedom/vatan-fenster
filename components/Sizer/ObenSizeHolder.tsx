...
import { smartDivider } from './SingleSizeHolder';
  ...
  return (
    <>
      ...
      <div id={style.central_holder}>
        ...
        <div id={style.heights} style={{ width: size?.h ? '75px' : '10px' }}>
              ...
              <div>
                ...
                <div id={style.height_unten}>
                  ...
                  <input
                    ...
                    placeholder="höhe"
                    className={sectionHeightHasProblems(multiHeight.untenHeight) ? style.warn : ''}
                    readOnly
                    disabled
                  />
                </div>
          ...
          <div id={style.height_total}>
            <h5>
              <span>Height Gesamt</span> <span id={style.range}>(1000-1700)</span>
            </h5>
            <input
              type="number"
