...
export const sprossenPricingList: Record<
  string,
  Record<string, { key: string; name: string; multiplier: number }[]>
> = {
  innenliegen: {
    8: [
...
export const sprossenPricingList3LayerGlassAufgesetzte: Record<
  string,
  Record<string, { key: string; name: string; multiplier: number }[]>
> = {
  aufgesetzte: {
